...
public class Settings extends Activity
{
	...
	// deze methode overriden we zodat we commando's kunnen uitvoeren zodra de
	// applicatie is opgestart
	// we voeren bijna nooit commando's uit in de constructor van een
	// userinterface object, maar in de onCreate(...)
	// de onCreate van deze Activity klasse wordt door Android aangeroepen als
	// deze eenmaal goed en wel draait
	@Override
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// we willen een lijst zien met data uit een reeks van MyListView
		// objecten
		// we halen eerst het ListView object op dat we in activity_main.xml
		// hebben gedefinieerd m.b.v. findViewById( R.id.object_id )
		...
		// we maken tot slot een adapter aan die de data (de arraylist) en de
		// lijst (de listview) aan elkaar koppelt
		// eerst een nieuwe adapter maken waar we de data (arraylist) aan
		// meegeven
		...
		// op deze manier hebben we een complete scheiding tussen businesslaag
		// en presentatielaag
		// de adapter is de mediator tussen de twee lagen, alle communicatie van
		// en naar beide lagen verloopt via de adapter
	}

	// deze methode overriden we en vullen we zelf in, zodat we een werkende
	// menubalk hebben
	// de code wordt automatisch gegenereerd bij het maken van een nieuw android
	// project
	@Override
